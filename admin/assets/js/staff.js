$(document).ready(function () {
  ...
  $(".container").on(
    "click",
    ".info-staff .table tbody .button-lock button",
    function () {
      var id = $(this).data("id");
      var type = "";
  ...
  $(".container").on(
    "click",
    ".info-staff .table tbody .fa-trash",
    function () {
      var id = $(this).data("id");
  ...
  $(".container").on(
    "click",
    ".info-staff .modal-dialog #remove-avatar",
    function (e) {
      e.preventDefault();
  ...
  $(".container").on(
    "click",
    ".info-staff .modal-dialog #change-avatar",
    function (e) {
      e.preventDefault();
      $("#avatar-input").click();
    }
  ...
  $(".container").on(
    "click",
    ".info-staff .modal-dialog #save-btn",
    function (e) {
      e.preventDefault();
      console.log(file);
  ...
  $(".container").on(
    "change",
    ".info-staff .staff-tools #itemOfPage",
    function () {
      var value = $(this).val();
  ...
  $(".container").on(
    "keyup change",
    ".info-staff .staff-tools .search input",
    () => {
      var valueInput = $(".container .info-staff .staff-tools input").val();
      var valueItem = $(".container .info-staff .staff-tools select").val();
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          $.ajax({
            ...
            success: function (response) {
              var count = Number(response);
              var page = Math.ceil(count / valueItem);
              var content = "";
              content += `
                        <li class="page-item">
                            <a class="page-link previous disabled" href="#" aria-label="Previous">
  ...
  $(".container").on(
    "click",
    ".info-staff .pagination ul.pagination .page-item .page-link:not(.previous):not(.next)",
    function (e) {
      e.preventDefault();
      var page = $(this).text();

      $(".info-staff .pagination ul.pagination .page-item").removeClass(
        "active"
      );
      $(this).parent().addClass("active");

      $(".info-staff .pagination ul.pagination .page-item a").removeClass(
        "disabled"
      );
  ...
  $(".container").on(
    "click",
    ".info-staff .pagination ul.pagination .page-item .page-link.next",
    function (e) {
      e.preventDefault();

      var pageCurrent = $(
        ".info-staff .pagination ul.pagination .page-item.active a"
      );
      $(".info-staff .pagination ul.pagination .page-item a").removeClass(
        "disabled"
      );
      ...
      if (
        pageCurrent.text() ==
        $(".info-staff .pagination ul.pagination .page-item").length
      ) {
        return;
      }
  ...
  $(".container").on(
    "click",
    ".info-staff .pagination ul.pagination .page-item .page-link.previous",
    function (e) {
      e.preventDefault();
      var pageCurrent = $(
        ".info-staff .pagination ul.pagination .page-item.active a"
