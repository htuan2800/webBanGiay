$(document).ready(function () {
  ...
  $(".main-panel").on(
    "change",
    ".container .info-product .product-tools .show select",
    function () {
      var value = $(this).val();
      $.ajax({
        type: "POST",
        ...
        success: function (response) {
          ...
          if ($(".container .info-product .pagination li").length - 2 == 1) {
            $(".container .info-product .pagination .next").addClass(
              "disabled"
            );
          }
        },
  ...
  $(".main-panel").on(
    "keyup change",
    ".container .info-product .product-tools .search input",
    () => {
      var valueInput = $(
        ".main-panel .container .info-product .product-tools .search input"
      ).val();
      var valueItem = $(
        ".main-panel .container .info-product .product-tools .search select"
      ).val();
      $.ajax({
        type: "POST",
        url: "./gui/tableProduct.php",
  ...
  $(".main-panel").on(
    "click",
    ".container .info-product tbody .fa-trash",
    function (e) {
      e.preventDefault();
      var id = $(this).data("id");
      Swal.fire({
  ...
  $(".main-panel").on(
    "click",
    ".container .info-product tbody .fa-edit",
    function (e) {
      e.preventDefault();
      var id = $(this).data("id");
      $.ajax({
        ...
        dataType: "html",
        success: function (response) {
          $(".main-panel .container .info-product .modal-dialog").html(
            response
          );
  ...
  function swapPage(page) {
    $.ajax({
      ...
      success: function (response) {
        ...
        for (
          var i = 0;
          i < $(".container .info-product .pagination li").length;
          i++
        ) {
          if (
            $(".container .info-product .pagination li").eq(i).text() == page
          ) {
            $(".container .info-product .pagination li")
              .eq(i)
              .addClass("active");
          }
        }
        if (page == 1) {
          $(".container .info-product .pagination .previous").addClass(
            "disabled"
          );
        } else {
          $(".container .info-product .pagination .previous").removeClass(
            "disabled"
          );
        }
        if (page == $(".container .info-product .pagination li").length - 2) {
          ...
          $(".container .info-product .pagination .next").removeClass(
            "disabled"
          );
        }
      },
  ...
  $(".main-panel").on(
    "click",
    ".container .info-product .pagination a",
    function (e) {
      e.preventDefault();
      var page = $(this).text();
      swapPage(page);
  ...
  $(".main-panel").on(
    "click",
    ".container .info-product .pagination .previous",
    function (e) {
      e.preventDefault();
      var pageCurrent = $(
  ...
  $(".main-panel").on(
    "click",
    ".container .info-product .pagination .next",
    function (e) {
      e.preventDefault();
      var pageCurrent = $(
        ".container .info-product .pagination li.active"
  ...
  $(".main-panel").on(
    "change",
    ".container .info-product .modal-dialog #brand",
    function () {
      var value = $(this).val();
      $.ajax({
        type: "POST",
        ...
        success: function (response) {
          ...
          var designType = $(
            ".container .info-product .modal-dialog #type option:selected"
          ).val();
  ...
  $(".main-panel").on(
    "change",
    ".container .info-product .modal-dialog #type",
    function () {
      var idProduct = $(
        ".container .info-product .modal-dialog #quantity-sold"
      ).data("id-product");
  ...
  $(".main-panel").on(
    "click",
    ".container .info-product .modal-dialog .btn-delete-image",
    function (e) {
      e.preventDefault();
  ...
  $(".main-panel").on(
    "click",
    ".container .info-product .modal-dialog .btn-update-image",
    function (e) {
      e.preventDefault();
  ...
  $(".main-panel").on(
    "change",
    ".container .info-product .modal-dialog .input-image",
    function (e) {
    ...
    function (e) {
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          var i =
            $(
              ".container .info-product .modal-dialog .accordion .accordion-item"
            ).length + 1;
          ...
          $(".container .info-product .modal-dialog .accordion").append(
            content
          );
        },
      });
  ...
  $(".main-panel").on("blur", ".modal-dialog #add-size", function () {
    ...
    var options = $(
      ".container .info-product .modal-dialog #select-size option"
    );
    ...
    var id = $(".container .info-product .modal-dialog #quantity-sold").data(
      "id-product"
    );
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $(".container .info-product .modal-dialog #quantity").val(
          $(
            ".container .info-product .modal-dialog #select-size option:selected"
          ).data("quantity")
        );
      },
    });
  ...
  $(".main-panel").on(
    "change",
    ".container .info-product .modal-dialog #select-size",
    function () {
