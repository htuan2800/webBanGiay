<div class="page-inner info-order-approval">
    <h3 class="page-title">Đơn hàng cần duyệt</h3>

    <div class="order-approval-tools">
        <div class="show">
            <span>Hiển thị </span>
    ...
    <div class="table-order-approval">
        <?php
            require_once __DIR__ . "/../../admin/gui/tableOrderApproval.php";
        ?>
    </div>
