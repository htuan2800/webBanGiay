<div class="page-inner info-order-deliveried">
    <h3 class="page-title">Đơn hàng đã hoàn thành</h3>

    <div class="order-deliveried-tools">
        <div class="show">
            <span>Hiển thị </span>
    ...
    <div class="table-order-deliveried">
        <?php
            require_once __DIR__ . "/../../admin/gui/tableOrderdeliveried.php";
        ?>
    </div>
