<?php
    ...
    if (isset($_POST['edit'])) {
        ...
        if (isset($_POST['avatarDefault'])) {
            ...
            echo $user->updateCustomerDefaultAvatar($id, $name, $phoneNumber, $email);
            exit();
        }
        ...
        if (isset($avatar)) {
            echo $user->updateCustomer($id, $name, $phoneNumber, $idRole, $email, $avatar);
        }
        else {
            echo $user->updateCustomer($id, $name, $phoneNumber, $idRole, $email, '');
        }
...
<div class="modal-content">
    ...
    <div class="modal-body">
        <form action="" class="container-fluid row">
            <div class="mb-4 col-6">
                ...
                <input type="text" class="form-control" id="full-name" placeholder="Nhập tên khách hàng"
    ...
    <div class="modal-footer d-flex justify-content-center">
        <button type="button" class="btn btn-primary" id="save-btn" data-id="<?php echo $customer['idUser']; ?>">Lưu thay
            đổi</button>
    </div>
</div>