$(document).ready(function () {
  ...
  $(".image .button-swap i").click(function () {
    var imgCurrent = $(".image .slide img.selected").attr("src");
    var index = 0;
  ...
  $(".container-fluid.detail-product .size button").click(function () {
    ...
    if (quantity == 0) {
      ...
      $(".container-fluid.detail-product .status span").addClass(
        "Out-of-Stock"
      );
      ...
      $(".container-fluid.detail-product .status span").removeClass(
        "Out-of-Stock"
      );
    }
  });
  ...
  $(".container-fluid.detail-product .quantity input").on(
    "keypress",
    function (e) {
  ...
  $(".container-fluid.detail-product .btn-cart").click(function () {
    ...
    var size = $(
      ".container-fluid.detail-product .size button.selected"
    ).text();
    ...
    if ($(".container-fluid.detail-product .price-and-star span").length == 2) {
      var price = $(
        ".container-fluid.detail-product .price-and-star span.current-price"
      )
        .text()
        .replace(/đ|\./g, "");
    } else {
      var price = $(".container-fluid.detail-product .price-and-star span")
        .text()
        .replace(/đ|\./g, "");
    }
    price = Number(price);
  ...
  $(".container-fluid.detail-product .btn-buy").click(function () {
    ...
    if (
      quantity >
      $(".container-fluid.detail-product .quantity input").attr("max")
    ) {
      return;
    }
    ...
    $.when(
      ...
      if (data === "fail") {
        ...
        $(".offcanvas-body .total .value").text(
    ...
    success: function (response) {
      ...
      if (response === "fail") {
        ...
        Swal.fire({
          ...
          text: "Vui lòng giảm số lượng hoặc chọn sản phẩm khác",
          icon: "warning",
        });
      }
      else {
